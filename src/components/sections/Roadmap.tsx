...
export function Roadmap() {
  // Создаем ref для каждого описания
          ...
          {quarters.map((quarter, index) => (
            ...
            >
              ...
              <p 
                ...
                className="w-full text-center text-text-secondary text-[24px] leading-[24px] font-bold uppercase transition-colors duration-300"
              >
                {quarter.description}
              </p>
            </div>
